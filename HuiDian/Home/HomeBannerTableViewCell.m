...
{
    NSString *searchCity = [[HDUserInfo shareUserInfos].locationCity substringToIndex:2];
...
- (UIView *)swipeView:(SwipeView *)swipeView viewForItemAtIndex:(NSInteger)index reusingView:(UIView *)view
{
    ...
    [imageView sd_setImageWithURL:[NSURL URLWithString:model.pic] placeholderImage:LoadingErrorDefaultImageBanner];
...
//            [self.viewController.navigationController pushViewController:goodsDVC animated:YES];
        ...
        case 3://跳转网页
        {
            ...
            if ([htmlVC.htmlUrl containsString:@"E50BA6517F660E7CA4A40EFD4508217E"]) {
                ...
                htmlVC.htmlUrl = [NSString stringWithFormat:@"%@&token=%@",model.jumpValue,[HDUserInfo shareUserInfos].token];
            }
