...
- (void)layoutSubviews
{
    ...
    self.markImageView.frame = CGRectMake(btnWidth * (mark - 1) + 20, self.frame.size.height - markHeight, btnWidth - 40 , markHeight);
...
- (void )setUI
{
    ...
    self.markImageView.backgroundColor = [UIColor blackColor];
